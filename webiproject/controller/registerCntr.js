...
const createReg = async (req, res) => {
  const {userId, firstName, lastName, email, phoneNumber, password ,conPassword} = req.fields;
  console.log(req.fields);

  if (!( userId&&firstName && lastName && email && phoneNumber && password &&conPassword)) {
...
module.exports={createReg,loginPage,forgetpassword,resetpassword,resetGetpassword};
